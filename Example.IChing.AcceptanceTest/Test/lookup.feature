Feature: Lookup
  ...
  Each hexagram has a name and a number. This conversion seems completely arbitrary 
  and nobody knows how this was defined.

  Scenario Outline: Lookup hexagram number
